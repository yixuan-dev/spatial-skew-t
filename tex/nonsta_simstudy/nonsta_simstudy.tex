...
non-$t$ extension 13--21; settings 16 and 20 at $n = 10$)}
...
score tables --- settings 16 and 20 at $n = 10$ on the full $K$ grid, the
...
tables --- settings 16 and 20 at $n = 10$ on the full $K$ grid, the other seven
...
16 & sigmoid\_front & mean, $\tanh$ arc front                    & mean & 3 \\
...
20 & transform\_mix & mean, log $+$ exp-decay $+$ ratio terms    & mean & 3 \\
21 & nonsmooth      & mean, hinge $+\,|\cdot|$ ($C^0$ creases)   & mean & 3 \\
\bottomrule
\multicolumn{5}{p{0.92\textwidth}}{\footnotesize $^{a}$ setting 2 was fitted at $K=0$ only (no MRTS sweep); it is excluded from the score tables. $^{b}$ settings 13--21: settings 16 and 20 at $n=10$ on the full $K$ grid, the other seven as $n=3$ pilots on $\Kmrts \in \{0,30,40,50\}$.}
\end{tabular}
\end{table}
...
which are at $n = 10$ on the full $K$ grid $\{0,3,5,8,10,12,15,20,25,30,40,50\}$.
