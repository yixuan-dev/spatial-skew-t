...
error law at large $K$. Their fitting is in progress; the design tables list
all 21 settings, while the score tables report settings that have been fitted.
...
\bottomrule
\multicolumn{5}{p{0.92\textwidth}}{\footnotesize $^{a}$ setting 2 was fitted at $K=0$ only (no MRTS sweep); it is excluded from the score tables. $^{b}$ settings 13--21 use the grid $\Kmrts \in \{0,30,40,50\}$; fitting is in progress (setting 13 complete at time of writing).}
\end{tabular}
\end{table}
